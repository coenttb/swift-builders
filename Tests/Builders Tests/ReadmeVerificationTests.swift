...
struct ReadmeVerificationTests {
  ...
  func overviewPermissionsSet() {
    ...
    #expect(
      permissions == [Permission.read, Permission.write, Permission.admin, Permission.delete]
    )
  }
  ...
  func dictionaryBuilderKeyValuePair() {
    ...
    let apiConfig: [String: Any] = Dictionary {
  ...
  func setBuilderPermissions() {
    ...
    #expect(
      userPermissions == [
        Permission.read, Permission.write, Permission.admin, Permission.delete, Permission.create,
      ]
    )
  }
}
